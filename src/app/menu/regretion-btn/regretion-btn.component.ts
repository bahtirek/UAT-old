...
@Component({
  selector: 'app-regretion-btn',
  templateUrl: './regretion-btn.component.html',
  styleUrls: ['./regretion-btn.component.less']
})
export class RegretionBtnComponent implements OnInit {
  ...
  activeBtn: string = '';
  currentBtn = "ui-br-ext-regretion-button";
